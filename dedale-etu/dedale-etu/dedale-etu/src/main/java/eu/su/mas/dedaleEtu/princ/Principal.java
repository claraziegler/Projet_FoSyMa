...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"A2", "A3","A4","A5","A6"};
		...
		Object [] entityParametersExplo2={"A1", "A3","A4","A5","A6"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo3={"A1", "A2","A4","A5","A6"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo4={"A1", "A2","A3","A5","A6"};
...
//		 * AGENT Explo5
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo5={"A1", "A2","A4","A3","A6"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo6={"A1", "A2","A4","A5","A3"};
